...
function getRequiredVerifierComments(crm = {}, fallback = 'NA') {
    const candidates = [
        crm.tlComments,
        crm.elComments,
...
module.exports = { getAddressConfirmBoolean, getYesNoBoolean, getInteriorValue, getExteriorValue, getResidenceConstructionValue, getLocalityValue, getTypeOfResidenceValue, getEaseOfLocateValue, getLandmarkValue, getRequiredVerifierComments, normalizeValue, computeYearsAtResidence, computeYearsInCity, getPostTimestamp, getResidenceStatusValue, getAreaSqFtRadioValue, getEarningMemberRadioValue };
