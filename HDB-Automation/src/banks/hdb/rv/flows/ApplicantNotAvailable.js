...
const DEFAULT_VALUES = Object.freeze({
  ...
  applicantDetailsConfirmed: true,
  residenceLocked: false,
  negativeFeedback: 'NA',
  // verifierName: '',
  verifierComments: 'Details Verfied',
  cpvRejectedReasons: '02',
  remarks: 'Applicant Not Available',
  noOfAttempts: '1',
...
async function fillApplicantNotAvailable(formPage, crm, manualAttachments) {
  ...
  // Block 1
  await safeFill(formPage, map.personMet, sanitizeStringOnly(crm.personMet, DEFAULT_VALUES.personMet));
  await safeFill(
    formPage,
    map.relation,
    sanitizeStringOnly(
      crm.relation || crm.tpcIs,
      DEFAULT_VALUES.relation
    )
  );
  ...
  //   crm.negativeCaseReason || comments || DEFAULT_VALUES.negativeFeedback
  // );
