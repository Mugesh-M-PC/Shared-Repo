...
async function fillNoSuchOffice(formPage, crm, manualAttachments) {
  ...
  const applicantNameVerifiedValue = getApplicantVerificationSource(crm) || DEFAULT_VALUES.applicantNameVerifiedFrom

  // await safeFill(
  //   formPage,
  //   map.applicantNameVerifiedFrom,
  //   applicantNameVerifiedValue
  // );
  ...
  await safeFill(
    ...
    map.applicantNameVerifiedFrom,
    sanitizeStringOnly(
      crm.personMet || crm.tpcName || DEFAULT_VALUES.applicantNameVerifiedFrom,
  ...
  const referencePersonValue = crm.tpcName || DEFAULT_VALUES.referencePersonName;
